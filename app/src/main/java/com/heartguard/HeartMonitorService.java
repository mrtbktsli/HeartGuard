...
public class HeartMonitorService extends Service {
    ...
    private static final String AUTH_KEY_HEX = "fedbff5a2242defb8c3d72ab45630821";private static final UUID XIAOMI_SERVICE_UUID = UUID.fromString("0000fe95-0000-1000-8000-00805f9b34fb");
